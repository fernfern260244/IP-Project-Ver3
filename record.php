            ...
            <div class = "bg-orange-200 rounded-md mt-16" style="width:600px; height: 400px;">
                        ...
                        <div class="">
                          <div class="flex flex-col   gap-y-4">
                            <div class="border border-1 shadow-md  mt-1 mb-8   rounded-full" style="width: 80px;height: 80px;">
                                <img class="" src="images/logo.png" >
                            </div> 
                            <p class="text2">ชื่อผู้ใช้</p>
                            <p class="text3">ชื่อ</p>
                            <p class="text4">อีเมล</p>
                            <p class="text5">หมายเลขโทรศัพท์</p>
                            <p class="text8">เพศ</p>
                            <p class="text9">วัน/เดือน/ปี</p>
                         </div>
                       </div>
